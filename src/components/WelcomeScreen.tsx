      ...
      <div className="max-w-md w-full bg-black border border-white/10 rounded-xl p-6 shadow-lg">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/70 text-sm mb-4">
            This application helps you ace technical interviews with two powerful modes:
          </p>
          
          <div className="space-y-3 mb-4">
            <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              <h3 className="text-white/90 font-medium mb-1">📸 Coding Mode</h3>
              <p className="text-white/70 text-xs">Take screenshots of coding problems and get AI-generated solutions</p>
            </div>
            
            <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              <h3 className="text-white/90 font-medium mb-1">🎤 Live Interview Mode</h3>
              <p className="text-white/70 text-xs">Real-time audio transcription and AI assistance during interviews</p>
            </div>
          </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
          ...
          <p className="text-white/70 text-sm mb-3">
            Before using the application, you need to configure your API key. <strong>Gemini is recommended for Live Interview Mode.</strong>
          </p>
          <Button 
        ...
        <div className="text-white/40 text-xs text-center">
          Choose your mode and start with screenshots (Ctrl+H) or live listening
        </div>
      </div>
    </div>
  );
